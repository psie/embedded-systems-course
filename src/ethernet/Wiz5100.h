...
namespace Wiz5100 {
    ...
    typedef enum : uint8_t {
         ...
         MR_MULTI  = 0x80  // support multicasting
    } S_MRVal;
    ...
    void sockRead(uint8_t sock, uint8_t *buf, uint16_t n);
    void sockWrite(uint8_t sock, uint8_t *buf, uint16_t seek, uint16_t n);
...
static const uint16_t MR   = 0x0000; // Mode register
static const uint16_t GAR  = 0x0001; // Gateway Address: 0x0001 - 0x0004
static const uint16_t SUBR = 0x0005; // Subnet mask Address: 0x0005 - 0x0008
static const uint16_t SAR  = 0x0009; // Source Hardware Address: 0x0009 - 0x000E
static const uint16_t SIPR = 0x000F; // Source IP Address: 0x000F - 0x0012
static const uint16_t RMSR = 0x001A; // RX Memory Size Register
static const uint16_t TMSR = 0x001B; // TX Memory Size Register

static const uint16_t S_BASE = 0x0400; // Start of socket0 fields
static const uint16_t S_NEXT = 0x0100; // Next socket offset

/* XXX below applies only to RMSR = TMSR = 0x55 (2K per socket) */
static const uint16_t BUF_SIZE = 2048; 
static const uint16_t TX_BUF_MASK = 0x07FF;
static const uint16_t TX_BUF_BASE = 0x4000;
static const uint16_t RX_BUF_MASK = 0x07FF;
static const uint16_t RX_BUF_BASE = 0x6000;
...
#define S_FIELD(sock, offset) S_BASE + (offset) + S_NEXT * (sock)
